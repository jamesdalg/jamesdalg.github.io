...
ternary_plot <- noaa_latlng  %>% 
 ...
 #    type = "scatterternary",
 #    mode = "markers",
 #    a = ~latitude, b = ~longitude, c = ~elevation, text = ~prcp#, 
 #    # marker = list( 
 #    #   symbol = 100,
 #    #   color = '#DB7365',
 #    #   size = 14,
 ...
 #    # )
 #    # 
 #  ) %>% #color = ~prcp, #size = ~snow,
 #    #add_markers(x = ~latitude, y = ~longitude, z = ~elevation, color = ~prcp) %>% 
 #  layout(
 #    title = "Geolocation, Altitude, and Precipitation in New York",
 #    ternary = list(
 #      sum = 100,
 #      aaxis = list(title = 'Latitude'),
 #      baxis = list(title = 'Longitude'),
 #      caxis = list(title = 'Elevation')
 #    )
 #  )
#snow_year_dist
